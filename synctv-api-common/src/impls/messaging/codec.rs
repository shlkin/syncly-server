...
pub fn room_member_event_to_proto(
...
pub fn chat_event_kind_to_proto(kind: ChatEventKind) -> synctv_proto::client::ChatMessageEventKind {
    match kind {
...
pub fn chat_pin_event_kind_to_proto(
...
#[cfg(test)]
pub fn chat_display_color_from_metadata(metadata: Option<&ChatMetadata>) -> Result<String, String> {
...
pub fn chat_message_event_to_proto(
...
pub fn chat_pin_event_to_proto(
    event: &ChatPinEvent,
    public_id_codec: &synctv_adapter::PublicIdCodec,
