...
pub fn media_cover_chunk_stream(
    download: synctv_core::models::FileObjectDownload,
...
pub fn media_thumbnail_chunk_stream(
    download: synctv_core::models::FileObjectDownload,
...
pub fn room_cover_chunk_stream(
    download: synctv_core::models::FileObjectDownload,
...
pub fn playlist_cover_chunk_stream(
    download: synctv_core::models::FileObjectDownload,
