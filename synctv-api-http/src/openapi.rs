...
use crate::http::{
    admin, auth, check_in, couple, couple_nest, email, friends, gift, livestream_webrtc, messaging,
    notifications, oauth2, public, room, room_extra, ticket, user, vod_source, watch_history,
...
use crate::providers::{
    ...
    playback_provider::{
        ...
        cloudreve as playback_provider_cloudreve, direct_url as playback_provider_direct_url,
        douyin as playback_provider_douyin, douyu as playback_provider_douyu,
        emby as playback_provider_emby, fnos as playback_provider_fnos,
        huya as playback_provider_huya, live_proxy as playback_provider_live_proxy,
        nextcloud as playback_provider_nextcloud, qnap as playback_provider_qnap,
        rtmp as playback_provider_rtmp, seafile as playback_provider_seafile,
        synology as playback_provider_synology, tiktok as playback_provider_tiktok,
...
#[openapi(
    paths(
        ...
        user::list_my_rooms,
        user::close_account,
        watch_history::list_watch_history,
        watch_history::record_watch_history,
        watch_history::clear_watch_history,
        watch_history::delete_watch_history_entry,
        watch_history::list_media_favorites,
        watch_history::add_media_favorite,
        watch_history::remove_media_favorite,
        watch_history::get_media_favorite_states,
        check_in::get_check_in_status,
        check_in::claim_check_in,
        check_in::list_point_transactions,
        gift::list_gifts,
        gift::send_gift,
        gift::list_gift_records,
        gift::get_gift_stats,
        gift::list_room_gifts,
        vod_source::list_vod_sources,
        couple_nest::get_couple_nest_home,
        couple_nest::list_couple_memories,
        couple_nest::create_couple_memory,
        couple_nest::update_couple_memory,
        couple_nest::delete_couple_memory,
        couple_nest::list_couple_albums,
        couple_nest::create_couple_album,
        couple_nest::rename_couple_album,
        couple_nest::delete_couple_album,
        couple_nest::list_couple_media,
        couple_nest::add_couple_media,
        couple_nest::move_couple_media,
        couple_nest::delete_couple_media,
        couple_nest::set_couple_space_cover,
        couple_nest::list_couple_anniversaries,
        couple_nest::create_couple_anniversary,
        couple_nest::update_couple_anniversary,
        couple_nest::delete_couple_anniversary,
        couple_nest::list_couple_todos,
        couple_nest::create_couple_todo,
        couple_nest::update_couple_todo,
        couple_nest::delete_couple_todo,
        couple_nest::get_couple_pet,
        couple_nest::adopt_couple_pet,
        couple_nest::update_couple_pet,
        couple_nest::interact_with_couple_pet,
        couple_nest::get_couple_pet_history,
        couple_nest::list_couple_ai_works,
        couple_nest::save_couple_ai_work,
        couple_nest::delete_couple_ai_work,
        couple::get_couple_space,
        couple::update_couple_space,
        couple::invite_couple_partner,
        couple::accept_couple_invite,
        couple::dismiss_couple_invite,
        couple::unbind_couple_space,
        couple::list_couple_favorites,
        couple::add_couple_favorite,
        couple::remove_couple_favorite,
        couple::list_couple_shared_watch_entries,
        ...
        friends::get_social_unread_summary,
        messaging::list_conversations,
        messaging::delete_conversation,
        messaging::open_direct_conversation,
        messaging::create_group_conversation,
        messaging::get_conversation,
        messaging::list_conversation_messages,
        messaging::send_conversation_message,
        messaging::delete_conversation_message,
        messaging::mark_conversation_read,
        messaging::set_conversation_muted,
        messaging::list_conversation_members,
        messaging::add_conversation_members,
        messaging::remove_conversation_member,
        messaging::leave_conversation,
        messaging::set_conversation_title,
        admin::get_check_in_config,
        admin::update_check_in_config,
        admin::list_conversations,
        admin::list_conversation_members,
        admin::list_conversation_messages,
        admin::list_gift_catalog,
        admin::create_gift,
        admin::update_gift,
        admin::delete_gift,
        admin::list_vod_sources,
        admin::create_vod_source,
        admin::update_vod_source,
        admin::delete_vod_source,
        ...
        playback_provider_cloudreve::get_cloudreve_resource,
        playback_provider_cloudreve::get_cloudreve_hls_manifest,
        playback_provider_cloudreve::get_cloudreve_hls_resource,
        playback_provider_cloudreve::get_cloudreve_subtitle,
        ...
        admin::ban_user,
        admin::get_room_chat_history,
        admin::get_room_chat_message_context,
        admin::moderate_room_chat_user,
        admin::unban_user,
    ...
    components(
        schemas(
            ...
            client::UpdateRoomVisibilityRequest,
            client::Room,
            ...
            synctv_proto::admin::RuntimeSettingsSnapshot,
            synctv_proto::admin::UpdateSettingsRequest,
            synctv_proto::admin::ImportSettingsRequest,
            synctv_proto::admin::ImportSettingsResponse,
    ...
    tags(
        ...
        (name = "Watch History", description = "Watch history and starred-media endpoints"),
        (name = "Check-In", description = "Daily check-in and points-ledger endpoints"),
        (name = "Couple Space", description = "Couple-space pairing, shared favorites and shared watch endpoints"),
        (name = "Friends", description = "Friend graph, friend requests and unread counters"),
        (name = "Messaging", description = "Direct-thread and group-conversation endpoints"),
