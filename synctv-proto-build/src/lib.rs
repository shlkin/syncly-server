...
fn build_main_protos(out_dir: &Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    builder = add_query_params_attrs(
        ...
        &[
            ...
            ".synctv.client.GetCoupleNestHomeRequest",
            ".synctv.client.ListCoupleMemoriesRequest",
            ".synctv.client.DeleteCoupleMemoryRequest",
            ".synctv.client.ListCoupleAlbumsRequest",
            ".synctv.client.DeleteCoupleAlbumRequest",
            ".synctv.client.ListCoupleMediaRequest",
            ".synctv.client.DeleteCoupleMediaRequest",
            ".synctv.client.ListCoupleAnniversariesRequest",
            ".synctv.client.DeleteCoupleAnniversaryRequest",
            ".synctv.client.ListCoupleTodosRequest",
            ".synctv.client.DeleteCoupleTodoRequest",
            ".synctv.client.GetCouplePetRequest",
            ".synctv.client.GetCouplePetHistoryRequest",
            ".synctv.client.ListCoupleAiWorksRequest",
            ".synctv.client.DeleteCoupleAiWorkRequest",
            ".synctv.client.GetUserProfileRequest",
            ".synctv.client.ListFollowingRequest",
            ".synctv.client.ListFollowersRequest",
            ".synctv.client.ListWatchHistoryRequest",
            ".synctv.client.ListMediaFavoritesRequest",
            ".synctv.client.RemoveMediaFavoriteRequest",
            ".synctv.client.ListPointTransactionsRequest",
            ".synctv.client.ListGiftRecordsRequest",
            ".synctv.client.ListRoomGiftsRequest",
            ".synctv.client.GetGiftStatsRequest",
            ".synctv.client.ListCoupleFavoritesRequest",
            ".synctv.client.RemoveCoupleFavoriteRequest",
            ".synctv.client.ListCoupleSharedWatchEntriesRequest",
            ".synctv.client.ListFriendsRequest",
            ".synctv.client.ListFriendRequestsRequest",
            ".synctv.client.ListConversationsRequest",
            ".synctv.client.GetConversationRequest",
            ".synctv.client.ListConversationMessagesRequest",
            ".synctv.client.ListConversationMembersRequest",
            ".synctv.client.DeleteConversationRequest",
            ".synctv.client.DeleteConversationMessageRequest",
            ".synctv.client.RemoveConversationMemberRequest",
            ...
            ".synctv.admin.ListGiftCatalogRequest",
            ".synctv.admin.ListVodSourcesRequest",
        ],
    );
